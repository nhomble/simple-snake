...
function $is_Lorg_hombro_snake_package$Direction(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_hombro_snake_package$Direction)))
}
function $as_Lorg_hombro_snake_package$Direction(obj) {
  return (($is_Lorg_hombro_snake_package$Direction(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.hombro.snake.package$Direction"))
}
function $isArrayOf_Lorg_hombro_snake_package$Direction(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_hombro_snake_package$Direction)))
}
function $asArrayOf_Lorg_hombro_snake_package$Direction(obj, depth) {
  return (($isArrayOf_Lorg_hombro_snake_package$Direction(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.hombro.snake.package$Direction;", depth))
}
/** @constructor */
function $c_O() {
  /*<skip>*/
...
/** @constructor */
function $c_Lorg_hombro_snake_App$() {
  $c_O.call(this);
  this.length$1 = 0;
  this.timeout$1 = 0;
  this.keys$1 = null;
...
$c_Lorg_hombro_snake_App$.prototype = new $h_O();
$c_Lorg_hombro_snake_App$.prototype.constructor = $c_Lorg_hombro_snake_App$;
/** @constructor */
function $h_Lorg_hombro_snake_App$() {
  /*<skip>*/
}
$h_Lorg_hombro_snake_App$.prototype = $c_Lorg_hombro_snake_App$.prototype;
$c_Lorg_hombro_snake_App$.prototype.init___ = (function() {
  $n_Lorg_hombro_snake_App$ = this;
  this.length$1 = 5;
  this.timeout$1 = 100;
  this.keys$1 = new $c_scm_HashSet().init___();
  this.interval$1 = $m_s_None$();
  return this
});
$c_Lorg_hombro_snake_App$.prototype.drawBorder__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(canvas, context) {
  var s = $m_Lorg_hombro_snake_package$().BORDER$1;
  context.fillStyle = s;
  context.fillRect(0.0, 0.0, $uI(canvas.width), this.length$1);
  context.fillRect(0.0, (($uI(canvas.height) - this.length$1) | 0), $uI(canvas.width), $uI(canvas.height));
  context.fillRect(0.0, 0.0, this.length$1, $uI(canvas.height));
  context.fillRect((($uI(canvas.width) - this.length$1) | 0), 0.0, $uI(canvas.width), $uI(canvas.height))
});
$c_Lorg_hombro_snake_App$.prototype.inflate__p1__T2__T2 = (function(cell) {
  return new $c_s_Tuple2$mcII$sp().init___I__I($imul(cell.$$und1$mcI$sp__I(), this.length$1), $imul(cell.$$und2$mcI$sp__I(), this.length$1))
});
$c_Lorg_hombro_snake_App$.prototype.drawCell__p1__T2__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__T__V = (function(cell, canvas, context, color) {
  context.fillStyle = color;
  var inflated = this.inflate__p1__T2__T2(cell);
  context.fillRect(inflated.$$und1$mcI$sp__I(), inflated.$$und2$mcI$sp__I(), this.length$1, this.length$1)
});
$c_Lorg_hombro_snake_App$.prototype.org$hombro$snake$App$$$anonfun$main$2__Lorg_scalajs_dom_raw_KeyboardEvent__O = (function(event) {
  var x1 = $m_Lorg_hombro_snake_package$().keyDirection__I__s_Option($uI(event.keyCode));
  if ($is_s_Some(x1)) {
    var x2 = $as_s_Some(x1);
    var direction = $as_Lorg_hombro_snake_package$Direction(x2.value$2);
    var this$1 = $m_Lorg_hombro_snake_App$().keys$1;
    $f_scm_FlatHashTable__removeElem__O__Z(this$1, direction);
...
$c_Lorg_hombro_snake_App$.prototype.clear__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(canvas, context) {
  context.clearRect(this.length$1, this.length$1, (((($uI(canvas.width) - this.length$1) | 0) - this.length$1) | 0), (((($uI(canvas.height) - this.length$1) | 0) - this.length$1) | 0))
});
$c_Lorg_hombro_snake_App$.prototype.gameStart__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(canvas, context) {
  var snake = new $c_Lorg_hombro_snake_Snake().init___I__I((($uI(canvas.width) / this.length$1) | 0), (($uI(canvas.height) / this.length$1) | 0));
  this.drawBorder__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(canvas, context);
  this.interval$1 = new $c_s_Some().init___O($m_sjs_js_timers_package$().setInterval__D__F0__sjs_js_timers_SetIntervalHandle(this.timeout$1, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, canvas$1, context$1, snake$1) {
    return (function() {
      var this$1 = $m_Lorg_hombro_snake_App$().keys$1;
      if ((this$1.tableSize$5 === 1)) {
        var this$2 = $m_Lorg_hombro_snake_App$().keys$1;
        snake$1.turn__Lorg_hombro_snake_package$Direction__V($as_Lorg_hombro_snake_package$Direction(new $c_scm_FlatHashTable$$anon$1().init___scm_FlatHashTable(this$2).next__O()))
      };
      snake$1.move__V();
      if ((!snake$1.isAlive__Z())) {
        ...
        $m_Lorg_hombro_snake_App$().clear__p1__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(canvas$1, context$1);
        snake$1.body__sci_Set().foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2$1, canvas$1$1, context$1$1) {
          return (function(c$2) {
            var c = $as_T2(c$2);
            $m_Lorg_hombro_snake_App$().drawCell__p1__T2__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__T__V(c, canvas$1$1, context$1$1, $m_Lorg_hombro_snake_package$().BODY$1)
          })
        })($this, canvas$1, context$1)));
        $m_Lorg_hombro_snake_App$().drawCell__p1__T2__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__T__V(snake$1.state$1.food$1, canvas$1, context$1, $m_Lorg_hombro_snake_package$().FOOD$1)
      }
    })
  })(this, canvas, context, snake))))
});
$c_Lorg_hombro_snake_App$.prototype.main__AT__V = (function(args) {
  ...
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().onkeydown = (function(arg1$2) {
    return $m_Lorg_hombro_snake_App$().org$hombro$snake$App$$$anonfun$main$1__Lorg_scalajs_dom_raw_KeyboardEvent__O(arg1$2)
  });
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().onkeyup = (function(arg1$2$1) {
    return $m_Lorg_hombro_snake_App$().org$hombro$snake$App$$$anonfun$main$2__Lorg_scalajs_dom_raw_KeyboardEvent__O(arg1$2$1)
  });
  ...
  while ((i$1 < len$1)) {
    ...
    var elem$1 = ((arg1$1 - ((arg1$1 % $m_Lorg_hombro_snake_App$().length$1) | 0)) | 0);
...
$c_Lorg_hombro_snake_App$.prototype.org$hombro$snake$App$$$anonfun$main$1__Lorg_scalajs_dom_raw_KeyboardEvent__O = (function(event) {
  var x1 = $m_Lorg_hombro_snake_package$().keyDirection__I__s_Option($uI(event.keyCode));
  if ($is_s_Some(x1)) {
    var x2 = $as_s_Some(x1);
    var direction = $as_Lorg_hombro_snake_package$Direction(x2.value$2);
    var this$1 = $m_Lorg_hombro_snake_App$().keys$1;
    $f_scm_FlatHashTable__addElem__O__Z(this$1, direction);
    event.preventDefault();
    return (void 0)
  } else {
    var x = $m_s_None$();
...
var $d_Lorg_hombro_snake_App$ = new $TypeData().initClass({
  Lorg_hombro_snake_App$: 0
}, false, "org.hombro.snake.App$", {
  Lorg_hombro_snake_App$: 1,
  O: 1
});
$c_Lorg_hombro_snake_App$.prototype.$classData = $d_Lorg_hombro_snake_App$;
var $n_Lorg_hombro_snake_App$ = (void 0);
function $m_Lorg_hombro_snake_App$() {
  if ((!$n_Lorg_hombro_snake_App$)) {
    $n_Lorg_hombro_snake_App$ = new $c_Lorg_hombro_snake_App$().init___()
  };
  return $n_Lorg_hombro_snake_App$
}
/** @constructor */
...
$c_Lorg_hombro_snake_SnakeState.prototype = new $h_O();
$c_Lorg_hombro_snake_SnakeState.prototype.constructor = $c_Lorg_hombro_snake_SnakeState;
/** @constructor */
function $h_Lorg_hombro_snake_SnakeState() {
  /*<skip>*/
}
...
$c_Lorg_hombro_snake_SnakeState.prototype.random__p1__sci_Set__T2 = (function(pairs) {
  ...
  var this$2 = pairs.diff__sc_GenSet__sc_Set($as_sc_SetLike(jsx$1).$$plus$plus__sc_GenTraversableOnce__sc_Set(this.parts$1));
  ...
  var this$4 = $m_sci_List$();
  return $as_T2($as_sc_IterableLike(jsx$3.shuffle__sc_TraversableOnce__scg_CanBuildFrom__sc_TraversableOnce(jsx$2, this$4.ReusableCBFInstance$2)).head__O())
});
$c_Lorg_hombro_snake_SnakeState.prototype.eat__sci_Set__Lorg_hombro_snake_SnakeState = (function(pairs) {
  ...
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.food$1]);
  var this$2 = $m_sci_List$();
  var cbf = this$2.ReusableCBFInstance$2;
...
}, false, "org.hombro.snake.SnakeState", {
  Lorg_hombro_snake_SnakeState: 1,
  O: 1
});
$c_Lorg_hombro_snake_SnakeState.prototype.$classData = $d_Lorg_hombro_snake_SnakeState;
/** @constructor */
function $c_Lorg_hombro_snake_package$() {
  $c_O.call(this);
  this.BLACK$1 = null;
  this.GREEN$1 = null;
  this.RED$1 = null;
...
$c_Lorg_hombro_snake_package$.prototype = new $h_O();
$c_Lorg_hombro_snake_package$.prototype.constructor = $c_Lorg_hombro_snake_package$;
/** @constructor */
function $h_Lorg_hombro_snake_package$() {
  /*<skip>*/
}
$h_Lorg_hombro_snake_package$.prototype = $c_Lorg_hombro_snake_package$.prototype;
$c_Lorg_hombro_snake_package$.prototype.init___ = (function() {
  $n_Lorg_hombro_snake_package$ = this;
  this.BLACK$1 = "#000000";
  this.GREEN$1 = "#00FF00";
  this.RED$1 = "#FF0000";
  this.BORDER$1 = this.BLACK$1;
  this.FOOD$1 = this.RED$1;
  this.BODY$1 = this.GREEN$1;
  return this
});
$c_Lorg_hombro_snake_package$.prototype.keyDirection__I__s_Option = (function(code) {
  switch (code) {
    case 87: {
      return new $c_s_Some().init___O(new $c_Lorg_hombro_snake_package$North().init___());
      break
    }
    case 65: {
      return new $c_s_Some().init___O(new $c_Lorg_hombro_snake_package$West().init___());
      break
    }
    case 83: {
      return new $c_s_Some().init___O(new $c_Lorg_hombro_snake_package$South().init___());
      break
    }
    case 68: {
      return new $c_s_Some().init___O(new $c_Lorg_hombro_snake_package$East().init___());
      break
    }
    case 38: {
      return new $c_s_Some().init___O(new $c_Lorg_hombro_snake_package$North().init___());
...
var $d_Lorg_hombro_snake_package$ = new $TypeData().initClass({
  Lorg_hombro_snake_package$: 0
}, false, "org.hombro.snake.package$", {
  Lorg_hombro_snake_package$: 1,
  O: 1
});
$c_Lorg_hombro_snake_package$.prototype.$classData = $d_Lorg_hombro_snake_package$;
var $n_Lorg_hombro_snake_package$ = (void 0);
function $m_Lorg_hombro_snake_package$() {
  if ((!$n_Lorg_hombro_snake_package$)) {
    $n_Lorg_hombro_snake_package$ = new $c_Lorg_hombro_snake_package$().init___()
  };
  return $n_Lorg_hombro_snake_package$
}
/** @constructor */
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lorg_hombro_snake_Snake() {
  $c_O.call(this);
  this.width$1 = 0;
  this.height$1 = 0;
  this.state$1 = null;
...
$c_Lorg_hombro_snake_Snake.prototype = new $h_O();
$c_Lorg_hombro_snake_Snake.prototype.constructor = $c_Lorg_hombro_snake_Snake;
/** @constructor */
function $h_Lorg_hombro_snake_Snake() {
  /*<skip>*/
}
$h_Lorg_hombro_snake_Snake.prototype = $c_Lorg_hombro_snake_Snake.prototype;
$c_Lorg_hombro_snake_Snake.prototype.productPrefix__T = (function() {
  return "Snake"
});
$c_Lorg_hombro_snake_Snake.prototype.productArity__I = (function() {
  return 2
});
$c_Lorg_hombro_snake_Snake.prototype.body__sci_Set = (function() {
...
$c_Lorg_hombro_snake_Snake.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lorg_hombro_snake_Snake(x$1)) {
    var Snake$1 = $as_Lorg_hombro_snake_Snake(x$1);
    return ((this.width$1 === Snake$1.width$1) && (this.height$1 === Snake$1.height$1))
  } else {
    return false
  }
});
$c_Lorg_hombro_snake_Snake.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.width$1;
      break
...
$c_Lorg_hombro_snake_Snake.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lorg_hombro_snake_Snake.prototype.init___I__I = (function(width, height) {
  this.width$1 = width;
  this.height$1 = height;
  var jsx$2 = new $c_s_Tuple2$mcII$sp().init___I__I(5, 2);
  var jsx$1 = new $c_Lorg_hombro_snake_package$East().init___();
  $m_sci_List$();
  ...
  while ((i < width)) {
    var arg1 = i;
    $m_sci_List$();
    var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_s_Tuple2$mcII$sp().init___I__I(arg1, 0), new $c_s_Tuple2$mcII$sp().init___I__I(arg1, this.height$1)]);
    var this$5 = $m_sci_List$();
    var cbf$1 = this$5.ReusableCBFInstance$2;
    var elem = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(xs$1, cbf$1));
  ...
  while ((i$1 < height)) {
    var arg1$1 = i$1;
    $m_sci_List$();
    var xs$2 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_s_Tuple2$mcII$sp().init___I__I(0, arg1$1), new $c_s_Tuple2$mcII$sp().init___I__I(this.width$1, this.height$1)]);
    var this$8 = $m_sci_List$();
    var cbf$2 = this$8.ReusableCBFInstance$2;
    var elem$1 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(xs$2, cbf$2));
    b$1.$$plus$eq__O__scm_ListBuffer(elem$1);
    i$1 = ((1 + i$1) | 0)
  };
  var xs$3 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, b$1.toList__sci_List()]);
  var this$10 = $m_sci_List$();
  var cbf$3 = this$10.ReusableCBFInstance$2;
  var this$13 = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(xs$3, cbf$3));
  var f = (function(this$3$1) {
    return (function(l$2) {
      ...
      while ((!these.isEmpty__Z())) {
        ...
        var xs$4 = $as_sc_GenTraversableOnce(arg1$2).seq__sc_TraversableOnce();
        b$2.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(xs$4);
        these = $as_sci_List(these.tail__O())
      };
      return b$2.toList__sci_List()
    })
  })(this);
  ...
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    if ((this$13 === $m_sci_Nil$())) {
      ...
      while ((rest !== $m_sci_Nil$())) {
        ...
        $as_sc_GenTraversableOnce(f(arg1$3)).seq__sc_TraversableOnce().foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, found$1, h$1, t$1) {
    ...
    while ((!these$1.isEmpty__Z())) {
      ...
      var xs$5 = $as_sc_GenTraversableOnce(f(arg1$4)).seq__sc_TraversableOnce();
      b$3.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(xs$5);
      these$1 = $as_sci_List(these$1.tail__O())
    };
    var jsx$4 = b$3.toList__sci_List()
  };
  this.border$1 = $as_sci_List(jsx$4);
  var end = (((-1) + width) | 0);
  var isEmpty$4 = (end <= 1);
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      ...
      if (isEmpty$4$1) {
        ...
        var hi$7 = (end$1 >> 31);
        var lo$4 = (((-1) + end$1) | 0);
        var hi$8 = ((lo$4 !== (-1)) ? hi$7 : (((-1) + hi$7) | 0));
        var hi$9 = (end$1 >> 31);
        var lo$5 = (((-1) + end$1) | 0);
        var t$3 = $m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong();
        var lo$6 = t$3.lo$2;
        var hi$11 = t$3.hi$2;
        if ((!((lo$6 === 0) && (hi$11 === 0)))) {
          var value$1 = 1
        ...
        var hi$12 = (value$1 >> 31);
        var lo$7 = ((lo$4 + value$1) | 0);
        var hi$13 = ((((-2147483648) ^ lo$7) < ((-2147483648) ^ lo$4)) ? ((1 + ((hi$8 + hi$12) | 0)) | 0) : ((hi$8 + hi$12) | 0));
        var scala$collection$immutable$Range$$numRangeElements$4$1 = (((hi$13 === 0) ? (((-2147483648) ^ lo$7) > (-1)) : (hi$13 > 0)) ? (-1) : lo$7)
      };
      ...
      if ((!isEmpty$4$1)) {
        ...
        while (true) {
          var arg1$6 = i$3;
          var elem$2 = new $c_s_Tuple2$mcII$sp().init___I__I(arg1$5, arg1$6);
      ...
      var this$36 = b$5.result__sci_Vector();
      $as_sci_VectorBuilder($f_scg_Growable__$$plus$plus$eq__sc_TraversableOnce__scg_Growable(b$4, this$36));
      if ((i$2 === scala$collection$immutable$Range$$lastElement$4)) {
        break
      };
      i$2 = ((1 + i$2) | 0)
    }
  };
  this.pairs$1 = b$4.result__sci_Vector();
  return this
});
$c_Lorg_hombro_snake_Snake.prototype.outOfBounds__p1__Z = (function() {
...
$c_Lorg_hombro_snake_Snake.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Lorg_hombro_snake_Snake.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lorg_hombro_snake_Snake.prototype.move__V = (function() {
  var head = $as_T2(this.state$1.parts$1.head__O());
  var x1 = this.state$1.direction$1;
  if ($is_Lorg_hombro_snake_package$North(x1)) {
    var next = new $c_s_Tuple2$mcII$sp().init___I__I(head.$$und1$mcI$sp__I(), (((-1) + head.$$und2$mcI$sp__I()) | 0))
  } else if ($is_Lorg_hombro_snake_package$South(x1)) {
    var next = new $c_s_Tuple2$mcII$sp().init___I__I(head.$$und1$mcI$sp__I(), ((1 + head.$$und2$mcI$sp__I()) | 0))
  } else if ($is_Lorg_hombro_snake_package$East(x1)) {
    var next = new $c_s_Tuple2$mcII$sp().init___I__I(((1 + head.$$und1$mcI$sp__I()) | 0), head.$$und2$mcI$sp__I())
  } else if ($is_Lorg_hombro_snake_package$West(x1)) {
    var next = new $c_s_Tuple2$mcII$sp().init___I__I((((-1) + head.$$und1$mcI$sp__I()) | 0), head.$$und2$mcI$sp__I())
  } else {
    var next;
    throw new $c_s_MatchError().init___O(x1)
  };
  if (next.equals__O__Z(this.state$1.food$1)) {
    var jsx$2 = this.state$1;
    var this$1 = this.pairs$1;
    var this$2 = $m_sci_Set$();
    var cbf = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$2);
    var jsx$1 = jsx$2.eat__sci_Set__Lorg_hombro_snake_SnakeState($as_sci_Set($f_sc_TraversableLike__to__scg_CanBuildFrom__O(this$1, cbf)))
  } else {
    var jsx$1 = this.state$1.move__T2__Lorg_hombro_snake_SnakeState(next)
  };
  this.state$1 = jsx$1
});
function $is_Lorg_hombro_snake_Snake(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_hombro_snake_Snake)))
}
function $as_Lorg_hombro_snake_Snake(obj) {
  return (($is_Lorg_hombro_snake_Snake(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.hombro.snake.Snake"))
}
function $isArrayOf_Lorg_hombro_snake_Snake(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_hombro_snake_Snake)))
}
function $asArrayOf_Lorg_hombro_snake_Snake(obj, depth) {
  return (($isArrayOf_Lorg_hombro_snake_Snake(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.hombro.snake.Snake;", depth))
}
var $d_Lorg_hombro_snake_Snake = new $TypeData().initClass({
  Lorg_hombro_snake_Snake: 0
}, false, "org.hombro.snake.Snake", {
  Lorg_hombro_snake_Snake: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lorg_hombro_snake_Snake.prototype.$classData = $d_Lorg_hombro_snake_Snake;
/** @constructor */
...
/** @constructor */
function $c_Lorg_hombro_snake_package$East() {
  $c_O.call(this)
}
$c_Lorg_hombro_snake_package$East.prototype = new $h_O();
$c_Lorg_hombro_snake_package$East.prototype.constructor = $c_Lorg_hombro_snake_package$East;
/** @constructor */
function $h_Lorg_hombro_snake_package$East() {
  /*<skip>*/
}
$h_Lorg_hombro_snake_package$East.prototype = $c_Lorg_hombro_snake_package$East.prototype;
$c_Lorg_hombro_snake_package$East.prototype.init___ = (function() {
  return this
});
$c_Lorg_hombro_snake_package$East.prototype.productPrefix__T = (function() {
  return "East"
});
$c_Lorg_hombro_snake_package$East.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_hombro_snake_package$East.prototype.equals__O__Z = (function(x$1) {
  return ($is_Lorg_hombro_snake_package$East(x$1) && ($as_Lorg_hombro_snake_package$East(x$1), true))
});
$c_Lorg_hombro_snake_package$East.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_hombro_snake_package$East.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lorg_hombro_snake_package$East.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
...
function $is_Lorg_hombro_snake_package$East(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_hombro_snake_package$East)))
}
function $as_Lorg_hombro_snake_package$East(obj) {
  return (($is_Lorg_hombro_snake_package$East(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.hombro.snake.package$East"))
}
function $isArrayOf_Lorg_hombro_snake_package$East(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_hombro_snake_package$East)))
}
function $asArrayOf_Lorg_hombro_snake_package$East(obj, depth) {
  return (($isArrayOf_Lorg_hombro_snake_package$East(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.hombro.snake.package$East;", depth))
}
var $d_Lorg_hombro_snake_package$East = new $TypeData().initClass({
  Lorg_hombro_snake_package$East: 0
}, false, "org.hombro.snake.package$East", {
  Lorg_hombro_snake_package$East: 1,
  O: 1,
  Lorg_hombro_snake_package$Direction: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lorg_hombro_snake_package$East.prototype.$classData = $d_Lorg_hombro_snake_package$East;
/** @constructor */
function $c_Lorg_hombro_snake_package$North() {
  $c_O.call(this)
}
$c_Lorg_hombro_snake_package$North.prototype = new $h_O();
$c_Lorg_hombro_snake_package$North.prototype.constructor = $c_Lorg_hombro_snake_package$North;
/** @constructor */
function $h_Lorg_hombro_snake_package$North() {
  /*<skip>*/
}
$h_Lorg_hombro_snake_package$North.prototype = $c_Lorg_hombro_snake_package$North.prototype;
$c_Lorg_hombro_snake_package$North.prototype.init___ = (function() {
  return this
});
$c_Lorg_hombro_snake_package$North.prototype.productPrefix__T = (function() {
  return "North"
});
$c_Lorg_hombro_snake_package$North.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_hombro_snake_package$North.prototype.equals__O__Z = (function(x$1) {
  return ($is_Lorg_hombro_snake_package$North(x$1) && ($as_Lorg_hombro_snake_package$North(x$1), true))
});
$c_Lorg_hombro_snake_package$North.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_hombro_snake_package$North.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
...
function $is_Lorg_hombro_snake_package$North(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_hombro_snake_package$North)))
}
function $as_Lorg_hombro_snake_package$North(obj) {
  return (($is_Lorg_hombro_snake_package$North(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.hombro.snake.package$North"))
}
function $isArrayOf_Lorg_hombro_snake_package$North(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_hombro_snake_package$North)))
}
function $asArrayOf_Lorg_hombro_snake_package$North(obj, depth) {
  return (($isArrayOf_Lorg_hombro_snake_package$North(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.hombro.snake.package$North;", depth))
}
var $d_Lorg_hombro_snake_package$North = new $TypeData().initClass({
  Lorg_hombro_snake_package$North: 0
}, false, "org.hombro.snake.package$North", {
  Lorg_hombro_snake_package$North: 1,
  O: 1,
  Lorg_hombro_snake_package$Direction: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_hombro_snake_package$North.prototype.$classData = $d_Lorg_hombro_snake_package$North;
/** @constructor */
function $c_Lorg_hombro_snake_package$South() {
  $c_O.call(this)
}
$c_Lorg_hombro_snake_package$South.prototype = new $h_O();
$c_Lorg_hombro_snake_package$South.prototype.constructor = $c_Lorg_hombro_snake_package$South;
/** @constructor */
function $h_Lorg_hombro_snake_package$South() {
  /*<skip>*/
}
$h_Lorg_hombro_snake_package$South.prototype = $c_Lorg_hombro_snake_package$South.prototype;
$c_Lorg_hombro_snake_package$South.prototype.init___ = (function() {
  return this
});
$c_Lorg_hombro_snake_package$South.prototype.productPrefix__T = (function() {
  return "South"
});
$c_Lorg_hombro_snake_package$South.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_hombro_snake_package$South.prototype.equals__O__Z = (function(x$1) {
  return ($is_Lorg_hombro_snake_package$South(x$1) && ($as_Lorg_hombro_snake_package$South(x$1), true))
});
$c_Lorg_hombro_snake_package$South.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_hombro_snake_package$South.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lorg_hombro_snake_package$South.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
...
function $is_Lorg_hombro_snake_package$South(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_hombro_snake_package$South)))
}
function $as_Lorg_hombro_snake_package$South(obj) {
  return (($is_Lorg_hombro_snake_package$South(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.hombro.snake.package$South"))
}
function $isArrayOf_Lorg_hombro_snake_package$South(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_hombro_snake_package$South)))
}
function $asArrayOf_Lorg_hombro_snake_package$South(obj, depth) {
  return (($isArrayOf_Lorg_hombro_snake_package$South(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.hombro.snake.package$South;", depth))
}
var $d_Lorg_hombro_snake_package$South = new $TypeData().initClass({
  Lorg_hombro_snake_package$South: 0
}, false, "org.hombro.snake.package$South", {
  Lorg_hombro_snake_package$South: 1,
  O: 1,
  Lorg_hombro_snake_package$Direction: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_hombro_snake_package$South.prototype.$classData = $d_Lorg_hombro_snake_package$South;
/** @constructor */
function $c_Lorg_hombro_snake_package$West() {
  $c_O.call(this)
}
$c_Lorg_hombro_snake_package$West.prototype = new $h_O();
$c_Lorg_hombro_snake_package$West.prototype.constructor = $c_Lorg_hombro_snake_package$West;
/** @constructor */
function $h_Lorg_hombro_snake_package$West() {
  /*<skip>*/
}
$h_Lorg_hombro_snake_package$West.prototype = $c_Lorg_hombro_snake_package$West.prototype;
$c_Lorg_hombro_snake_package$West.prototype.init___ = (function() {
  return this
});
$c_Lorg_hombro_snake_package$West.prototype.productPrefix__T = (function() {
  return "West"
});
$c_Lorg_hombro_snake_package$West.prototype.productArity__I = (function() {
  return 0
});
$c_Lorg_hombro_snake_package$West.prototype.equals__O__Z = (function(x$1) {
  return ($is_Lorg_hombro_snake_package$West(x$1) && ($as_Lorg_hombro_snake_package$West(x$1), true))
});
$c_Lorg_hombro_snake_package$West.prototype.productElement__I__O = (function(x$1) {
  throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
});
$c_Lorg_hombro_snake_package$West.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
...
function $is_Lorg_hombro_snake_package$West(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_hombro_snake_package$West)))
}
function $as_Lorg_hombro_snake_package$West(obj) {
  return (($is_Lorg_hombro_snake_package$West(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.hombro.snake.package$West"))
}
function $isArrayOf_Lorg_hombro_snake_package$West(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_hombro_snake_package$West)))
}
function $asArrayOf_Lorg_hombro_snake_package$West(obj, depth) {
  return (($isArrayOf_Lorg_hombro_snake_package$West(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.hombro.snake.package$West;", depth))
}
var $d_Lorg_hombro_snake_package$West = new $TypeData().initClass({
  Lorg_hombro_snake_package$West: 0
}, false, "org.hombro.snake.package$West", {
  Lorg_hombro_snake_package$West: 1,
  O: 1,
  Lorg_hombro_snake_package$Direction: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lorg_hombro_snake_package$West.prototype.$classData = $d_Lorg_hombro_snake_package$West;
/** @constructor */
function $c_T2() {
  $c_O.call(this);
  this.$$und1$f = null;
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$m_Lorg_hombro_snake_App$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=simple-snake-fastopt.js.map
